...
TEST_CASE("StockAnalyzer::cumulative_return", "[metrics][cumret]") {
...
TEST_CASE("StockAnalyzer::simple_returns length", "[metrics][returns]") {
...
TEST_CASE("StockAnalyzer::log_returns length", "[metrics][returns]") {
...
TEST_CASE("StockAnalyzer::max_drawdown on a decline", "[metrics][drawdown]") {
...
TEST_CASE("StockAnalyzer::max_drawdown on monotonically increasing prices", "[metrics][drawdown]") {
