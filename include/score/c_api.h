...
ScoreStatus score_stock_cumulative_return    (const ScoreStockAnalyzer* sa,
                                              double* out);
ScoreStatus score_stock_annualized_return    (const ScoreStockAnalyzer* sa,
                                              int periods,
                                              double* out);
ScoreStatus score_stock_annualized_volatility(const ScoreStockAnalyzer* sa,
                                              int periods,
                                              double* out);
ScoreStatus score_stock_sharpe_ratio         (const ScoreStockAnalyzer* sa,
                                              double rf,
                                              int periods,
                                              double* out);
ScoreStatus score_stock_max_drawdown         (const ScoreStockAnalyzer* sa,
                                              double* out);
